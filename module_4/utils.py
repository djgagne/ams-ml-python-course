...
def permutation_test_for_cnn(
    ...
    these_probabilities = apply_cnn(cnn_model_object=cnn_model_object,
                                    predictor_matrix=predictor_matrix)
    print(MINOR_SEPARATOR_STRING)
